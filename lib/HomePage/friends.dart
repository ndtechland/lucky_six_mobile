              ...
              children: [
                RotatedBox(
                  ...
                  child: Container(
                    ...
                    padding: EdgeInsets.only(top: MediaQuery.of(context).viewInsets.top + 39,bottom: MediaQuery.of(context).viewInsets.bottom + 30,left: MediaQuery.of(context).viewInsets.left + 25),
                    child: Align(
                              ...
                              child: Container(
                                  ...
                                  decoration: BoxDecoration(
                                      image: DecorationImage(
                                          ...
                                          fit: BoxFit.cover)),
                                  child: Padding(
                                    padding:  EdgeInsets.only(top: MediaQuery.of(context).viewInsets.top + 13),
                                    child: Column(
                                      children: [
                                        Container(
                        ...
                        child: TabBarView(
                          ...
                          children: [
                            RotatedBox(
                              ...
                              child: Container(
                                decoration: BoxDecoration(
                                  border: Border.all(color: Colors.amber,width: MediaQuery.of(context).size.width*0.0020),
                                  ...
                                  children: [
                                    ...
                                    Container(
                                      ...
                                      child:  Padding(
                                        ...
                                        child: Text("INVITE",style: TextStyle(color: Color(0xffefd43c),fontSize: 19,fontWeight: FontWeight.bold),),
                                      ),
                                    ),
