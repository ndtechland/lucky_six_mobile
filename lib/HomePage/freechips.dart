...
class Free_chips extends StatefulWidget {
  const Free_chips({Key? key}) : super(key: key);

  @override
  State<Free_chips> createState() => _Free_chipsState();
}

class _Free_chipsState extends State<Free_chips>with SingleTickerProviderStateMixin {
