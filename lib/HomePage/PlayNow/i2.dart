            ...
            child: Column(
              children: [
                Container(
                  ...
                  decoration: BoxDecoration(
                      image: DecorationImage(image: AssetImage("assets/images/tableinfotxt.png"),fit: BoxFit.fill)
                  ),
                ),
                Row(
                  children: [
                    ...
                    Padding(
                      padding:  EdgeInsets.only(top:  MediaQuery.of(context).viewInsets.top + 15.0,left:  MediaQuery.of(context).viewInsets.left + 10),
                      child: Container(
