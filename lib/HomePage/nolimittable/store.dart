...
class _StoreState extends State<Store> {
        ...
        children: [
          ...
          Positioned(
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                  image: DecorationImage(
                      image: AssetImage("assets/images/storeside.png"),
                      fit: BoxFit.fill)),
            ),
          ),
          Positioned(
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                  image: DecorationImage(
                      image: AssetImage("assets/images/storeside2.png"),
                      fit: BoxFit.fill)),
            ),
          ),
          Positioned(
          ...
          Positioned(
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                  image: DecorationImage(
                      image: AssetImage("assets/images/hammer.png"),
                      fit: BoxFit.fill)),
            ),
          ),
          Positioned(
  ...
  payin() async {
    final response = await http.post(
      Uri.parse(ApiConst.baseurl + "payin"),
      headers: <String, String>{
        'Content-Type': 'application/json; charset=UTF-8',
      },
      body: jsonEncode(<String, String>{"rusers_id": "2", "amount": "10"}),
    );
