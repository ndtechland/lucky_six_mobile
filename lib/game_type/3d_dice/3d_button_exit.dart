...
class ExitIconButton extends StatefulWidget {
  //final VoidCallback onPressed;

  const ExitIconButton({Key? key}) : super(key: key);

  @override
  _ExitIconButtonState createState() => _ExitIconButtonState();
}

class _ExitIconButtonState extends State<ExitIconButton> {
