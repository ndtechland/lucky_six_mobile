...
class Play_Now_2_old_dice extends StatefulWidget {
  const Play_Now_2_old_dice({Key? key}) : super(key: key);

  @override
  State<Play_Now_2_old_dice> createState() => _Play_Now_2_old_diceState();
}

class _Play_Now_2_old_diceState extends State<Play_Now_2_old_dice> {
